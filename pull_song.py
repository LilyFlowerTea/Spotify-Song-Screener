...
#Viens on s'aime
track_id = "https://open.spotify.com/track/1KSFqVqZm5QQXr9FLsppSL"

#excited playlist with one calm song, size = 4
# playlist_id = "https://open.spotify.com/playlist/1LT8KdqwwTuSgLHXy4oK45"
#calm playlist with some excited songs, size = 8
playlist_id = "https://open.spotify.com/playlist/6zIveFrPfn88thBqO4VxlM"
...
print(f'Target song name is: "{track_name}"')
