...
def pull_ids(sp, track_url : str, comparison_url : str, method : ComparisonMethod):
    ...
    id_dict = {"target" : {}, "comparison tracks" : {}}
...
def pull_data_by_id(sp, track_url : str, comparison_url : str, method : ComparisonMethod):
    (track_name,
     comparison_name,
     id_dict,
     ids,
     comparison_type) = pull_ids(sp,
                                 track_url,
                                 comparison_url,
                                 method)
